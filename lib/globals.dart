...
const Map<String, String> requests = {
  ...
  'search': 'https://api.themoviedb.org/3/search/%s?query=%s&include_adult=true&language=en-US&page=%s&api_key=e2c7d1908816457a2156268c1fb5d7ae',
  'image': 'https://image.tmdb.org/t/p/w500%s',
};

const List<DropdownMenuItem<int>> movieGenreItems = [
...
const List<DropdownMenuItem<int>> tvGenreItems = [
  DropdownMenuItem(value: 0, child: Text( 'None' )),
